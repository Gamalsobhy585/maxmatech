...
[
    ...
    'validation' => [
        ...
        'product_id_required' => 'حقل رقم المنتج مطلوب.',
        'product_id_exists' => 'المنتج المحدد غير موجود.',
        'category_id_required' => 'حقل رقم الفئة مطلوب.',
        ...
        'tax_numeric' => 'يجب أن تكون الضريبة رقمًا.',
        'tax_min' => 'يجب ألا تقل الضريبة عن 0.',
        'discount_required' => 'حقل الخصم مطلوب.',
        'discount_numeric' => 'يجب أن يكون الخصم رقمًا.',
        'discount_min' => 'يجب ألا يقل الخصم عن 0.',
   ...
   "product" =>
    ...
    [
        ...
        'get_all' => 'تم جلب جميع الفواتير بنجاح.',
        'get' => 'تم جلب الفاتورة بنجاح.',
        'create' => 'تم إنشاء الفاتورة بنجاح.',
        'update' => 'تم تحديث الفاتورة بنجاح.',
        'get_failed' => 'فشل في جلب الفاتورة.',
        'create_failed' => 'فشل في إنشاء الفاتورة.',
        'update_failed' => 'فشل في تحديث الفاتورة.',
        'price_calculated' => 'تم حساب سعر البيع بنجاح.',
        'total_calculated' => 'تم حساب الإجمالي بنجاح.',
        'calculation_failed' => 'فشل في حساب الإجمالي.',
